...
options.extend([{'label': launch_site, 'value': launch_site} for launch_site in launch_sites])
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=options, value='ALL', placeholder="", searchable=True),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    grouped_df = filtered_df.groupby(['Launch Site', 'class']).size().reset_index(name="count")
    grouped_df1 = grouped_df[grouped_df['class'] == 1]
    print(grouped_df1)
    if entered_site == 'ALL':
        fig = px.pie(grouped_df1, values='count',
        names='Launch Site',
